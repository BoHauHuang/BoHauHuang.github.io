...
//         if (member.username) {
//           const match_id = ids.find(
//             id => objs[id].username == member.username
//           );
//           if (match_id) {
//             memberErrors.username = objs[match_id].name;
//             memberArrayErrors[memberIndex] = memberErrors;
//           }
//         }
//       });
...
export default connect(
  mapStateToProps,
  editActions
)(reduxForm({ form: "EventSignup", validate, warn })(EventSignup));
